...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-20 md:py-32 bg-white dark:bg-gray-900 dark:text-white min-h-screen flex items-center"
    >
        ...
        >
          ...
          <motion.div className="md:w-1/2" variants={itemVariants}>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6 text-lg">
              I am a student in Term 3 of Full Stack Web Development in Red River College, Canada. With a strong
              foundation in both client-side and server-side development from one year college training and one year
              self-learning, I deliver seamless, responsive user experiences backed by scalable and robust backend
              systems.
            </p>
