      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Interested in working together? Feel free to reach out! I'm always open to discussing new projects, creative
                ...
                <div className="flex space-x-4">
                  {['linkedin', 'github'].map((social, i) => (
                    <a
                      ...
                      href={
                        social === 'github'
                          ? 'https://github.com/William-WYL'
                          : 'https://www.linkedin.com/in/wei-wang-31261078/'
                      }
